...
export const IMAGE_TOOLS: ImageTool[] = [
  ...
  { slug: 'convert-to-jpg', label: 'Convert to JPG', description: 'Turn PNG or GIF into JPG', icon: FileImage, to: '/images/convert-to-jpg', category: 'convert', ready: true },
  { slug: 'crop-image', label: 'Crop Image', description: 'Trim the edges of a photo', icon: Crop, to: '/images/crop', category: 'edit', ready: false },
  { slug: 'convert-from-jpg', label: 'Convert from JPG', description: 'Turn a JPG into PNG, GIF, or WEBP', icon: FileImage, to: '/images/convert-from-jpg', category: 'convert', ready: false },
  { slug: 'watermark-image', label: 'Watermark Image', description: 'Stamp text over a photo', icon: Droplets, to: '/images/watermark', category: 'edit', ready: false },
  { slug: 'photo-editor', label: 'Photo Editor', description: 'Add text, frames, and stickers', icon: PencilLine, to: '/images/editor', category: 'create', ready: false },
  { slug: 'meme-generator', label: 'Meme Generator', description: 'Caption an image in seconds', icon: Smile, to: '/images/meme', category: 'create', ready: false },
